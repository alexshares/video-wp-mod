...
class video_wp_300px extends WP_Widget {
     function video_wp_300px() {
	    $widget_ops = array('description' => esc_html__('Advertisement - Paste your HTML or JavaScript code.', 'video_wp'));
        parent::__construct(false, $name = ''. esc_html__('Custom: Advertisement 300px', 'video_wp') .'',$widget_ops); 
    }
...
?>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('bcode'); ?>"><?php esc_html_e( 'Paste your HTML or JavaScript code here:', 'video_wp' ); ?></label>      
...
<?php  } }
add_action('widgets_init', create_function('', 'return register_widget("video_wp_300px");')); // register widget
?>