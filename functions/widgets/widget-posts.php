...
class video_wp_recentposts extends WP_Widget {
     function video_wp_recentposts() {
      $widget_ops = array('description' => esc_html__('Your site\'s most recent Posts.', 'video_wp'));
        parent::__construct(false, $name = ''. esc_html__('Custom: Recent Posts', 'video_wp') .'',$widget_ops); 
    }
...
<?php  } } 
add_action('widgets_init', create_function('', 'return register_widget("video_wp_recentposts");')); // register widget
?>