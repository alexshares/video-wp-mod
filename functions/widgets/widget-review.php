...
class video_wp_bestreviews extends WP_Widget {
    function video_wp_bestreviews() {
      $widget_ops = array('description' => esc_html__('Your site\'s Best Reviews.', 'video_wp'));
      parent::__construct(false, $name = ''. esc_html__('Custom: Best Reviews', 'video_wp') .'',$widget_ops); 
    }
...
<?php  } } 
add_action('widgets_init', create_function('', 'return register_widget("video_wp_bestreviews");')); // register widget
?>