...
class video_wp_recentreviews extends WP_Widget {
    function video_wp_recentreviews() {
      $widget_ops = array('description' => esc_html__('Your site\'s Recent Reviews.', 'video_wp'));
      parent::__construct(false, $name = ''. esc_html__('Custom: Recent Reviews', 'video_wp') .'',$widget_ops); 
    }
...
<?php  } } 
add_action('widgets_init', create_function('', 'return register_widget("video_wp_recentreviews");')); // register widget
?>